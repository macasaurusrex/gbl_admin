...
ActiveRecord::Schema[7.2].define(version: 2024_12_02_150239) do
  ...
  create_table "bulk_actions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "bulk_action_type", default: "ChangePublicationState", null: false
    t.string "action"
  end
  ...
  create_table "document_distributions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["friendlier_id", "reference_type_id", "url"], name: "idx_on_friendlier_id_reference_type_id_url_d302644a61", unique: true
